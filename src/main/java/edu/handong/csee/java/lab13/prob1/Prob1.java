...
public class Prob1 { // a class which can access from other package
	...
	public static void main(String[] args) { // a void method, invoked by the system
		...
		InstanceOf.isWhatFriend(friend1); // calls whatfriend in instanceof class, put friend 1 as input
		InstanceOf.isWhatFriend(friend2); // calls whatfriend in instanceof class, put friend 2 as input
		InstanceOf.isWhatFriend(friend3); // calls whatfriend in instanceof class, put friend 3 as input
